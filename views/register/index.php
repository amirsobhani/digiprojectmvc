...
<div id="conten">
    <div class="register-wrapper">
        <div class="register-box-icon">
            ...
            <h1>به دیجی کالا بپیوندید</h1><!--register-box-icon-->
        </div>
        <div class="register">
            <div id="right-register">
                <div class="inside-register">
                    ...
                    <div class="agreement">
								<span  class="active-check" style="bottom: 30px;
right: 3px;"><i class="fa fa-check" aria-hidden="true"></i></span>
                        <input type="checkbox" class="check-box">
                        <label>حریم خصوصی و شرایط و قوانین استفاده از سرویس های سایت دیجی‌کالا را مطالعه نموده و با کلیه موارد آن موافقم.</label>
                    </div>
                    <div class="lastNews">
								<span class="active-check" style="right: 3px;
top: 3px;"><i class="fa fa-check" aria-hidden="true"></i></span>
                        <input type="checkbox" class="check-box">
                        <label>خبرنامه دیجی کالا را برای من ارسال کنید.</label>
                    </div>
                    <div class="submit">
                        <button type="submit">ثبت نام در دیجی کالا</button>
                    </div>
                </div>
