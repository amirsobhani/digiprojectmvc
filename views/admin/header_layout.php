...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="/digiprojectmvc/views/admin/dist/css/bootstrap-theme.css" type="text/css">
    <!-- Bootstrap rtl -->
    <link rel="stylesheet" href="/digiprojectmvc/views/admin/dist/css/rtl.css">
    <!-- persian Date Picker -->
    <link rel="stylesheet" href="/digiprojectmvc/views/admin/dist/css/persian-datepicker-0.4.5.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/digiprojectmvc/views/admin/bower_components/font-awesome/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="/digiprojectmvc/views/admin/bower_components/Ionicons/css/ionicons.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="/digiprojectmvc/views/admin/dist/css/AdminLTE.css">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="/digiprojectmvc/views/admin/dist/css/skins/_all-skins.min.css">
    <!-- Morris chart -->
    <link rel="stylesheet" href="/digiprojectmvc/views/admin/bower_components/morris.js/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="/digiprojectmvc/views/admin/bower_components/jvectormap/jquery-jvectormap.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="/digiprojectmvc/views/admin/bower_components/bootstrap-daterangepicker/daterangepicker.css">
    ...
    <link rel="stylesheet" href="/digiprojectmvc/views/admin/bower_components/sweetalert2/dist/sweetalert2.css" >
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-right">
                                                <img src="/digiprojectmvc/views/admin/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                علیرضا
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-right">
                                                <img src="/digiprojectmvc/views/admin/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                نگین
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-right">
                                                <img src="/digiprojectmvc/views/admin/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                نسترن
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/digiprojectmvc/views/admin/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
