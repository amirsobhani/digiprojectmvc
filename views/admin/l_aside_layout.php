...
<!-- Bootstrap 3.3.7 -->
<script src="/digiprojectmvc/views/admin/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- Morris.js charts -->
<script src="/digiprojectmvc/views/admin/bower_components/raphael/raphael.min.js"></script>
<script src="/digiprojectmvc/views/admin/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="/digiprojectmvc/views/admin/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="/digiprojectmvc/views/admin/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="/digiprojectmvc/views/admin/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="/digiprojectmvc/views/admin/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="/digiprojectmvc/views/admin/bower_components/moment/min/moment.min.js"></script>
<script src="/digiprojectmvc/views/admin/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="/digiprojectmvc/views/admin/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="/digiprojectmvc/views/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
<script src="/digiprojectmvc/views/admin/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
